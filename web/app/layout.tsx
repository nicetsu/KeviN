 ...
 *
 * `themeColor` ใช้**สีพื้น** (`--bg`) ไม่ใช่สีแถบล่าง (เคาะรอบสอง 1 ก.ย. 2026)
 *
 * รอบแรกใช้สีแถบล่างเพราะคิดว่าควรกลืนกัน — แต่พอเทียบกับแอปที่ทำเรื่องนี้ดี
 * (Major Cineplex) เห็นว่าเขาให้พื้นรอบขีดปัดเป็น**สีพื้นแอป** แล้วปล่อยให้
 * แถบเมนูลอยอยู่เหนือมันอีกชั้น · ตาจึงอ่านออกว่ามีสองชั้น ไม่ใช่ก้อนหนาก้อนเดียว
 */
