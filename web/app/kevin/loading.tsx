    ...
    <Skeleton name="talk">
      <main className="wrap">
        <div className="talk">
          ...
          {/*
            ⚠️ **โครงร่างมีแค่วงกลมนิ่ง ๆ ไม่มีคลื่น** (2 ก.ย. 2026)
               คลื่นย้ายไปเล่นบน `VoiceCall` เพราะที่นี่มันโดนตัดกลางคันเสมอ —
               เซิร์ฟเวอร์ตอบเร็วกว่าความยาวคลื่นมาก โครงร่างจึงหายไปก่อนมันจบ
               ที่นี่เหลือหน้าที่เดียวคือ **จองตำแหน่งให้ตรงกับของจริง**
          */}
