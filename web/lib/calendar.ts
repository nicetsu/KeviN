...
export type CalendarEntry = {
  ...
  label: string | null
  /**
   * ตั้งใจไม่ไป · **ยังอยู่ในผลลัพธ์** ไม่ถูกกรองทิ้ง
   * ฝั่งเว็บทำให้จางลงและติดป้ายแทนการซ่อน ตามหลัก UX ข้อ 5
   * "ไม่มีอะไรหายเงียบ ๆ" — ถ้าหายไปเลยจะไม่รู้ว่าเคยตัดสินใจไว้หรือกดผิด
   */
  skipped: boolean
  /** เวลาถูกตัดจากของจริง เพราะไปชนกับอย่างอื่น */
  trimmed: boolean
}
 ...
 *
 * `--event` อยู่ที่ 45° ห่างจากม่วงแบรนด์ 152° ผ่านกฎระยะห่างสีใน ARCHITECTURE.md §9
 */
