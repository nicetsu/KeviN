...
test('แถวผู้ใช้ที่ไม่มีข้อความอยู่แล้วก็ยังได้ placeholder', () => {
  // ตั้งแต่ 1 ก.ย. 2026 ฝั่งเบราว์เซอร์ไม่เก็บข้อความที่ผู้ใช้พูดเลย
  // ส่งมาเป็นค่าว่าง — แถวต้องยังมีอยู่ ไม่งั้นประวัติจะเหลือแต่คำตอบลอย ๆ
  assert.deepEqual(
    redactVoiceTurns([{ role: 'user', content: '' }]),
