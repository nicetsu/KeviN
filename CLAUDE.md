...
- **ยังไม่มีหน้า login** — RLS ใช้ `auth.uid()` ถ้าไม่ล็อกอิน เว็บจะอ่านไม่เห็นสักแถว ต้องมีก่อนเฟส 2
- ยังไม่มีโค้ดแอปสักบรรทัด (มีแต่ SQL ใน `doc/phase0/`)
- เวลาของงาน UniHack 2026 ที่เป็น onsite ตั้ง 09:00 ไว้ชั่วคราว รอเวลาจริง
- สัปดาห์สอบกลางภาค (week_offset 7) ยังมีคาบเรียนอยู่ ถ้าจริงไม่มีเรียนต้องตัดออก
